...
def test_session_state_path_rejects_traversal(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_session_state_path_rejects_path_separator(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_session_state_path_rejects_too_long(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_session_state_path_accepts_well_formed(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
